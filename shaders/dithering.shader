...
PS
{
    ...
    CreateTexture2D( g_tFrameTexture ) < Attribute( "FrameTexture" ); SrgbRead( true ); Filter( MIN_MAG_LINEAR_MIP_POINT ); AddressU( MIRROR ); AddressV( MIRROR ); >;
    ...
    { 	
        ...
        float4 color = Tex2D( g_tFrameTexture, i.vPositionSs.xy / g_vViewportSize.xy ).rgba;
