...
public partial class GraphicActor : Panel
{
	...
	private readonly Stack<Action<GraphicActor>> _modifyActionStack = new();
	...
	/// <summary> GraphicActor rect in panel units </summary>
	...
	/// <summary> Request an GraphicActor modification </summary>
	/// <param name="action">Action</param>
	public void Modify( Action<GraphicActor> action ) => _modifyActionStack.Push( action );
